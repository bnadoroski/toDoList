<template>
    <v-app id="inspire">
            ...
            <v-img src="https://picsum.photos/1920/1080?random"
                ...
                <v-list class="avatar">
                    <v-list-item
                        ...
                        subtitle="ToDo List" title="Bruna Nadoroski">
                    </v-list-item>
                </v-list>
            </v-img>
        ...
        <v-app-bar color="teal" image="https://picsum.photos/1920/1080?random" density="prominent">
            ...
            <v-app-bar-title>Lista Compras</v-app-bar-title>
        </v-app-bar>
